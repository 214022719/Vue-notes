        ...
        <div class="from-wrap">
            ...
            <Form ref="loginData" :model="loginData" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem class="form-footer">
                    ...
                    <Button type="primary" ghost @click="handleReset('loginData')" style="margin-left: 8px">重置</Button>
                </FormItem>
            </Form>
        </div>
    </div>
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          // }
           ...
           //     },
           //   failureRes =>{
           //       this.$Message['error']({content:failureRes.message,background:true})
           //   }
